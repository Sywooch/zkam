...
class AdminController extends Controller
{
    ...
    public function actionEdit($id)
    {
        ...
        return $this->render('edit', [
            ...
            'model' => $item, 'all_cats' => $tree->view_cat_for_parent($tree->get_cat()), 'all_characters' => $all_characters, 'active_cats' => $active_cats, 'active_podcats' => $active_podcats,'arenda_types'=>$arenda_types,
            'active_arenda_types'=>$active_arenda_types
        ]);
    }
